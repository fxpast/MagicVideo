...
/*
 ...
 Abstract: App delegate to manage a Core Data stack. It adds inferred migration to the persistentStoreCoordinator method.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"AppData.MagicVideo"];
